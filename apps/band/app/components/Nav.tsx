...
export default function Nav({ sections, fixed = true }: { sections: NavElement[] | null, fixed?: boolean }) {
  ...
  return (
      <nav className={`${fixed ? 'fixed top-0 left-0 right-0 z-50' : ''} bg-black/80 backdrop-blur-md border-b border-white/10`}>
